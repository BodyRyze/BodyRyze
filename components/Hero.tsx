  ...
  return (
    <section className="relative flex min-h-[100dvh] w-full flex-col items-center justify-center overflow-hidden px-6 py-16 text-center sm:py-32">
      ...
      <div className="relative z-10 flex max-w-5xl flex-col items-center">
        ...
        <a
          href="#histoire"
          className="hero-in hero-d3 text-3d-sm group mt-7 inline-flex items-center gap-2 text-lg uppercase tracking-wide text-[#98a2b8] transition hover:text-white"
        >
          Voir avant / après
          <span className="transition group-hover:translate-x-1">→</span>
        </a>
