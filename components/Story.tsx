      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mt-16 flex flex-col items-center gap-10 sm:flex-row sm:items-start sm:justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="group-glow flex flex-nowrap gap-3 overflow-x-auto sm:gap-6">
              <div className="group relative min-w-[320px] max-w-[600px] flex-1 overflow-hidden rounded-none border-2 border-[#1e6bff]/50 shadow-[0_0_40px_rgba(30,107,255,0.35)] ring-1 ring-white/10 transition duration-300 hover:-translate-y-1 hover:border-[#1e6bff]/80 hover:shadow-[0_0_60px_rgba(30,107,255,0.6)]">
